...
public class FourFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding=FragmentFourBinding.inflate(LayoutInflater.from(requireActivity()),container,false);
    ...
    private void getData() {
        ...
        String string = bundle.getString("user3");
    ...
    private void sendData(){
        binding.click.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                bundle.putString("user4",string);
                FiveFragment fiveFragment= new FiveFragment();
                fiveFragment.setArguments(bundle);
                getActivity().getSupportFragmentManager().beginTransaction().replace(R.id.container, fiveFragment).commit();
            }
        });
    }
